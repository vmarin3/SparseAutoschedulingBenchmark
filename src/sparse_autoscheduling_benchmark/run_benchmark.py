...
data_generators = {"matmul_dense_small" : dg_matmul_dense_small,
...
def main():
    ...
    parser.add_argument("--data-generator", default="matmul_sparse_small", choices=list(data_generators.keys()), help="Data generator to use")
