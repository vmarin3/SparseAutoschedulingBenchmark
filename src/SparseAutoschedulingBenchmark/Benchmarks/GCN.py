...
Motivation: "Graphs are widely used for abstracting complex systems of interacting objects,
...
"""
    benchmark_gcn(xp, adjacency_bench, features_bench, weights1_bench, bias1_bench, weights2_bench, bias2_bench)
...
def benchmark_gcn(xp, adjacency_bench, features_bench, weights1_bench, bias1_bench, weights2_bench, bias2_bench):
